...
class BaseTuner(nn.Module, ABC):
    ...
    def __init__(self, model, peft_config: Union[PeftConfig, dict[str, PeftConfig]], adapter_name: str) -> None:
        ...
        self.injected_modules = nn.ModuleList([])
    ...
    def inject_adapter(self, model: nn.Module, adapter_name: str):
        ...
        # set grad to true for all trainable params
        self.update_trainable_params()
    
    def update_trainable_params(self):
        for injected_module in self.injected_modules:
            for name, param in injected_module.named_parameters():
...
class BaseTunerLayer(ABC):
    ...
    def set_adapter(self, adapter_names: str | list[str]) -> None:
        ...
        # print(self, self.adapter_layer_names)
        
        ## TODO: need to set module grad
        # self.
        # for layer_name in self.adapter_layer_names:
        #     print(self.get_base_layer)
